...
1. ✅ 开发/修复的完整代码变更
2. ✅ 单元测试全部通过（来自 feature-dev / bug-fix）
3. ✅ 变更摘要（来自 feature-dev / bug-fix）
4. ✅ ChangeLog 条目（来自 feature-dev / bug-fix）
5. ✅ 代码评审报告（来自 code-review）
6. ✅ 阻断问题已修复（如有）
7. ✅ 任务交付文档（输出至 `docs/delivery/` 目录）
